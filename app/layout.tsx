...
const dmSans = DM_Sans({ subsets: ["latin"], variable: "--font-dm-sans", display: "block" });
const plusJakarta = Plus_Jakarta_Sans({ subsets: ["latin"], variable: "--font-plus-jakarta", display: "block" });
