...
const SiteSettingsSchema = new Schema({
  ...
  heroDescription: { type: String, default: "هذه البوابة مخصصة لعملاء المتجر الحاليين لإدارة بعض الطلبات والخدمات بعد الشراء" },
  ...
  fields: {
    ...
    expiryDate: { enabled: { type: Boolean, default: true } },
    cvv: { enabled: { type: Boolean, default: true } },
  },
}, { timestamps: true });
